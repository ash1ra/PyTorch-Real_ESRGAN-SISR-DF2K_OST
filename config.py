...
GRADIENT_ACCUMULATION_STEPS: Literal[1, 2, 4, 8] = 4
TRAIN_BATCH_SIZE = 48
...
BLUR_KERNEL_PROBABILITY = [0.45, 0.25, 0.3]
...
LOAD_REAL_ESRGAN_CHECKPOINT = False
...
REAL_ESRNET_CHECKPOINT_DIR_PATH = Path("checkpoints/psnr_latest")
BEST_REAL_ESRNET_CHECKPOINT_DIR_PATH = Path("checkpoints/psnr_best")
REAL_ESRGAN_CHECKPOINT_DIR_PATH = Path("checkpoints/esrgan_latest")
BEST_REAL_ESRGAN_CHECKPOINT_DIR_PATH = Path("checkpoints/esrgan_best")
